...
// initializations
const contract_addr = "5G1nF71sda8kSFQDCt4KsgZN7BkY3q1d5BdiqSv89eXYfqhQ";
...
app.post('/create-election', (req, res) => {
    ...
    form.parse(req, function (err, fields, files) {
        ...
        createElection(fields.names, fields.parties, fields.hours, total_uri, res);
    });
});
...
async function loadElection(req, res) {
    ...
    // if (hash) {
        ...
        const { gasRequired, storageDeposit, result, output } = await contract.query.winner(
            alice.address, {
            gasLimit,
            storageDepositLimit,
        });
...
async function createElection(names, parties, hours, total_uri, res) {
    let ipfs_str = "";
